...
type ProjectCategory = 'ALL' | 'AI/ML/DL' | 'Webdev';
const categories: ProjectCategory[] = ['ALL', 'AI/ML/DL', 'Webdev'];
                ...
                {filteredProjects.map((project, index) => (
                    <ProjectCard
                        ...
                        links={project.links.map(link => ({
                            ...link,
                            icon: link.icon as "github" | "jupyter" | "document" | "linkedin" | "mail" | "resume"
                        }))}
                    />
                ))}
            </div>
