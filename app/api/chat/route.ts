...
- Himanshu Lodha is an AI and Data Scientist Enthusiast
- Education: B.Tech in AI & DS from MITS
- Experience: Data Science & Machine Learning Intern at Bonasys IT Solutions and Cognifyz Technologies – Developed predictive models, performed data cleaning and transformation, and implemented ML algorithms for classification, regression, and NLP-based sentiment analysis using Python and SQL.
- Specializes in Machine Learning, Data Science, and LLMs`);
    }
...
export async function POST(req: NextRequest) {
  try {
    ...
    const prompt = `You are Himanshu Support, a friendly and professional chatbot for Himanshu Lodha's portfolio website. 
Your goal is to help potential employers and visitors learn about Himanshu's skills, experience, and projects.

RELEVANT CONTEXT ABOUT HIMANSHU:
${context}
...
INSTRUCTIONS:
- Use the provided context to give specific, accurate answers about Himanshu's experience
- If asked about projects, certifications, mention specific technologies and provide details
- If asked about experience, reference actual companies and roles
- Be enthusiastic about Himanshu's capabilities and achievements
