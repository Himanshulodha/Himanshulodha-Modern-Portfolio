...
import { 
  ...
  SiNodedotjs, SiTailwindcss, SiHtml5, SiDjango, SiFlask, SiMongodb, SiPostgresql, SiMysql,
...
import { CursorAIIcon } from '../ui/icons/CursorAIIcon';
...
const skills: Skill[] = [
  ...
  { name: 'PyTorch', icon: SiPytorch, category: 'ai', primary: false },
  // { name: 'OpenCV', icon: SiOpencv, category: 'ai', primary: false },
  ...
  { name: 'Cursor AI', icon: CursorAIIcon, category: 'ai', primary: true },
  // Web3/Blockchain
            ...
            return (
              <div
                ...
                onClick={e => {
                  ...
                  // if want to add that only for mobiles
                  e.stopPropagation();
