      ...
      <div className="flex flex-col-reverse lg:flex-row items-start gap-12">
        ...
        <div className="flex-1 space-y-8">
          ...
          <div className="space-y-8">
            ...
            Passionate about AI and Data, blending intelligence with seamless user experiences. With a strong academic foundation, I achieved an <b>All India Rank of 1886 in NCAT</b>, reflecting my commitment to innovation and excellence in the field.
            </p>
          ...
          <div className="flex flex-wrap gap-4">
            {/* Resume Button */}
            <Link
              href="https://drive.google.com/file/d/1dV-4M9qmORCxohHVQLADK3UdfHVi-jQL/view?usp=drive_link"
              target="_blank"
            ...
            {socialsData.socials.map((social) => {
              ...
              const href =
                social.name === "GitHub"
                  ? "https://github.com/Himanshulodha"
                  : social.href;
              return (
                <a
                  key={social.name}
        ...
        <div className="lg:w-80 w-full flex justify-center lg:justify-end">
          <div className="relative">
            <div className="w-64 h-80 lg:w-72 lg:h-96 rounded-2xl overflow-hidden bg-gradient-to-br from-blue-100 to-blue-200 dark:from-blue-900 dark:to-blue-800 shadow-lg">
              <Image
                src="/HL_photo.jpg"
                alt="Himanshu Lodha - AI Developer"
                width={300}
                height={400}
