...
export function ChatBot() {
  ...
  const suggestedMessage = "Tell me more about Himanshu?";
          ...
          <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">Himanshu Support</p>
              </div>
            </div>
            <button
              onClick={closeChat}
            ...
            {messages.length === 0 && (
              <div className="text-center py-12">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  I&apos;m a RAG-powered AI assistant with comprehensive knowledge about Himanshu&apos;s background, skills, and projects!
                </p>
              </div>
            )}
